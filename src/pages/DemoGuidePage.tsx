...
const STEPS = [
  ...
  },
  {
    ...
    route: "/reports",
    point: "처리 메모, 상태 변경 사유, 담당자/우선순위 저장과 첨부파일 업로드 API를 보여줍니다.",
    status: "API 연결",
  },
  {
  ...
  },
  {
    ...
    point: "건물별 리포트, 고위험 미해결 항목, PDF/CSV 내보내기와 스냅샷 저장 API를 보여줍니다.",
    status: "API 연결",
  },
];
...
const SCRIPT_CARDS = [
  {
    ...
    time: "00:00 - 03:00",
    lines: [
      "베프는 장애학생의 일상 제보를 학교 개선 근거로 바꾸는 관리자 플랫폼입니다.",
  ...
  },
  {
    ...
    lines: [
      ...
      "관리자는 제보 상세에서 담당자, 우선순위, 처리 메모와 첨부파일을 API로 저장합니다.",
      "경험 피드는 익명화 전/후 비교를 거쳐 공개되고, 공감 데이터는 리포트로 축적됩니다.",
      "현재는 PDF/CSV, 공공데이터 수집 결과, 원본 데이터 상세 조회까지 Spring Boot API로 확인할 수 있습니다.",
    ],
  },
];
...
const PRE_DEMO_CHECKS = [
  ...
  "경험 피드 익명화 전/후 비교 확인",
  "월간 리포트 PDF/CSV 버튼과 공공데이터 원본 조회가 Spring Boot API 기준으로 동작하는지 확인",
      ...
      <main className="page">
        <div className="page-h">
          <div>
            <h1>시연 가이드</h1>
            <div className="sub">
              발표 때 베프 관리자 웹을 어떤 순서로 보여줄지 정리한 안내 화면입니다.
            </div>
          </div>
          ...
          <div className="panel">
            ...
            <div className="quality-list">
              <div>
                ...
                <span>제보/도움 요청/리포트/PDF/첨부파일/공공데이터 원본 조회는 API 기준이고, 외부 전송·실시간 알림·실제 LLM은 추가 예정입니다.</span>
              </div>
              <div>
