...
| Mock 또는 규칙 기반 | 발표 모드, 일부 안내 Toast, 규칙 기반 익명화/추천 |
...
| `#/public-data` | 공공데이터와 현장 제보 비교, 원본/정규화/지도 레이어 확인 |
