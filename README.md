...
ONDA 관리자 웹은 장애대학생의 접근성 제보, 도움 요청, 경험 피드, 공공데이터 참고 정보를 학교/장애학생지원센터가 확인하고 개선 우선순위를 검토할 수 있게 만든 공모전 시연용 React 대시보드입니다. AI와 공공데이터는 최종 판단이 아니라 관리자 결정을 돕는 보조 근거입니다.
